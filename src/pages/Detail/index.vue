          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
               ...
               <button @click="GOODS(666)">测试vuex修改数据方法</button>
               <h3 @click="myFn">测试打印仓库数据</h3>
               <p v-test="'hello'">自定义指令</p>
               <br>
               <p>{{goodsTest}}</p>
...
import direc from './directives/directives'
...
export default {
  ...
  data() {
    return {
      //购买产品的个数
      skuNum: 1,
      goodsTest:[{name:'电脑',price:1000},{name:'手机',price:500}]
    };
  },
  components: {
    ImageList,
  ...
  methods: {
    //修改数据
    changeInfo(){
      this.$set(this.goodsTest,0,{name:'电视'})
      //mock 模拟数据
      getData().then(res=>{
        console.log(123,res);
      })
   ...
   ...mapMutations(['GOODS']),
    ...
    async addShopcar() {
      ...
      // this.$store.commit('GOODS','456')
      // console.log(this.$store.state.detail.goods );
      try {
        //成功
